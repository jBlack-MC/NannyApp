<?php
/**
 * The real DB connection lives in NannyApp.Shared so both the web app and
 * the Android app's API use the exact same database and uploaded files.
 * Falls back to a fully standalone connection if NannyApp.Shared isn't
 * checked out next to this project (e.g. this folder deployed alone).
 */
...
if (is_file($sharedConfig)) {
    ...
    if (!defined('SHARED_STORAGE_DIR')) define('SHARED_STORAGE_DIR', __DIR__ . '/../assets/uploads');
